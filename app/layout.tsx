...
export const metadata: Metadata = {
  title: "Kevin Zong | Personal Portfolio",
  description: "Kevin Zong is a backend developer with 2 years of experience.",
};
    ...
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div
          ...
          h-[31.25rem] w-[31.25rem] rounded-full blur-[8rem]
          sm:w-[68.75rem] dark:bg-[#946263]"
        ></div>
        <div
          className="bg-[#dbd7fb] absolute top-[-1rem] -z-10 left-[-35rem]
          h-[31.25rem] w-[50rem] rounded-full blur-[8rem]
